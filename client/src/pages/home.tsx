...
export default function Home() {
  ...
  useEffect(() => {
    ...
    if (paymentStatus === 'success') {
      toast({
        ...
        description: "You now have full access to all features. Refreshing...",
      });
      // Clear query params and reload page to update hasPaidForAccess status
        ...
        <div className="container max-w-6xl mx-auto px-4 py-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription className="text-base leading-relaxed">
                  Access to comprehensive legal consultation and in-depth officer search
                </CardDescription>
              </CardHeader>
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                <div className="flex items-center gap-2">
                  <Badge variant="secondary">FOIA Request</Badge>
                </div>
                <div className="flex items-center gap-2">
                  <Badge variant="secondary">Officer Complaint</Badge>
                </div>
                <div className="flex items-center gap-2">
                  <Badge variant="secondary">Officer Resignation Petition</Badge>
                </div>
              </CardContent>
              <CardFooter>
                <Button
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-2xl">Civil Lawsuits</CardTitle>
                <CardDescription className="text-base leading-relaxed">
                  Civilsuits tailored per your state's requirements, with relevant statutes, legal codes, and precedence. Choose between two options: The first is 'You file' the civilsuit, to save money, complete with filing instructions. The second is 'BadBlue files' the civilsuit, and the filing process is done for you, complete with coversheet.
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-3">
                <div className="flex items-center gap-2">
                  <Badge variant="secondary">You File Civilsuit</Badge>
                </div>
                <div className="border rounded-lg p-3 bg-muted/50">
                  <div className="flex items-center gap-2 mb-1">
                    <Badge variant="secondary">BadBlue Files Civilsuit</Badge>
                  </div>
                  <p className="text-xs text-muted-foreground font-medium">
                    (less than the cost of a consultation with a civil rights attorney)
                  </p>
                </div>
              </CardContent>
              <CardFooter>
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        title="BadBlue Dashboard - Police Accountability Tools & Officer Search"
        description="Access comprehensive police accountability tools including officer search, legal consultation, FOIA requests, complaints, petitions, and civil rights lawsuits. Search police officers, find officer information, locate department details, and get legal help."
        ...
        ogTitle="BadBlue Dashboard - Complete Police Accountability Platform"
        ogDescription="Search police officers, file complaints and lawsuits, request FOIA documents, and get legal consultation for police accountability cases."
      />
      {/* Header */}
      <header className="sticky top-0 z-50 border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container flex h-14 items-center gap-4 px-4">
