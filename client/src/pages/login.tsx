...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        title="BadBlue - File Police Complaints & Civil Rights Lawsuits Online"
        description="File police misconduct complaints and civil rights lawsuits online. Step-by-step AI-powered platform guides you through reporting excessive force, false arrest, police brutality, and discrimination. Automated routing to Internal Affairs. Access includes LegalAI Consultation and Officer Search."
