...
export default function LawsuitForm() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        title="File Civil Rights Lawsuit - 42 USC 1983 Claims Online | BadBlue"
        description="File a Section 1983 civil rights lawsuit online against police misconduct. Professional legal templates for excessive force, false arrest, wrongful arrest, and constitutional violations. State-specific court forms. $29.99 per filing."
